...
modified (изменённый) -- "git add" --> staged (в списке на коммит);
staged (в списке на коммит) -- "git commit" --> tracked (отслеживаемый);
tracked (отслеживаемый) -- "внесение изменений" --> modified (изменённый);
staged (в списке на коммит) -- "внесение изменений" --> modified (изменённый);
```
